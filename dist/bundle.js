...
var _contactDetails = __webpack_require__(33);
...
function setState(changes) {
    ...
    var MainView = _react2.default.createElement(
        'div',
        { className: 'wrap' },
        _react2.default.createElement(_contactList.ContactList, { items: state.items }),
        _react2.default.createElement(_contactDetails.ContactDetails, { item: item })
    );
                        ...
                        return React.createElement(
                            ...
                            React.createElement(
                                ...
                                React.createElement(
                                    'figure',
                                    null,
                                    React.createElement('img', { src: item.picture.thumbnail, alt: (0, _lib.formatName)(item.name) }),
                                    React.createElement(
                                        'figcaption',
                                        null,
                                        React.createElement(
                                            'p',
                                            null,
                                            (0, _lib.formatName)(item.name)
                                        ),
                                        React.createElement(
                                            'span',
                                            null,
                                            (0, _lib.formatDOB)(item.dob)
                                        )
                                    )
                                )
                            )
                ...
                return React.createElement(
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'figure',
                            null,
                            React.createElement('img', { src: this.props.item.picture.large, alt: (0, _lib.formatName)(this.props.item.name) }),
                            React.createElement(
                                'figcaption',
                                null,
                                React.createElement(
                                    'h2',
                                    null,
                                    (0, _lib.formatName)(this.props.item.name, true)
                                ),
                                React.createElement(
                                    'span',
                                    null,
                                    (0, _lib.formatDOB)(this.props.item.dob),
                                    ' ( ',
                                    (0, _lib.getAge)(this.props.item.dob),
                                    ' years old )'
                                )
                            )
                        )
                    ...
                    React.createElement(
                        ...
                        React.createElement(
                            'p',
                            null,
                            (0, _lib.formatLocation)(this.props.item.location, 1)
                        ),
                        React.createElement(
                            'p',
                            null,
                            (0, _lib.formatLocation)(this.props.item.location, 2)
                        ),
                        React.createElement(
                            'p',
                            null,
                            (0, _lib.formatLocation)(this.props.item.location, 3)
                        )
                    )
                );
            }
